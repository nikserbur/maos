...
| Производственный план | Этап 5 (планировщик), Гантт | ⬜ `src/domain/planning.ts` |
| Требования к оптимизации | Этап 6 (оптимизация) | ⬜ `src/domain/planning.ts` |
| Требования эвристики | Этап 6 (оптимизация) | ⬜ |
| Сценарии моделирования | Этап 7 (сценарии/аналитика) | 🟡 `src/domain/planning.ts` |
